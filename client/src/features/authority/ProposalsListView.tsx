  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Development Proposals & Prioritization</h2>
          <p className="text-xs text-gray-500">Objective decision-support ranking competing civic capital works for Bhubaneswar</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card className="p-4 bg-white border">
          ...
          <p className="text-xs text-gray-500">Bhubaneswar municipal wards</p>
        </Card>
        ...
        <Card className="p-4 bg-white border">
          ...
          <p className="text-xs text-gray-500">Deterministic multi-criteria engine</p>
        </Card>
      </div>
      ...
      {/* Proposals List */}
      {loading ? (
        <div className="py-12 text-center text-gray-500">Loading proposals...</div>
      ) : proposals.length === 0 ? (
            ...
            return (
              <Card 
                ...
                className={`p-5 transition-all hover:shadow-md cursor-pointer border ${
                  isSelected ? 'border-indigo-500 bg-indigo-50/20' : 'bg-white'
                }`}
              ...
              >
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div>
                      <div className="flex flex-wrap items-center gap-2 mb-1.5">
                        ...
                        <span className="text-[11px] font-bold px-2 py-0.5 rounded bg-gray-100 text-gray-700 uppercase tracking-wider">
                          {proposal.category}
                        </span>
                        {proposal.wardId && (
                  ...
                  <div className="flex items-center gap-6 self-end lg:self-center bg-gray-50 p-3 rounded-xl border">
